...
const BLOG_BODY_TEXTS: Record<string, string> = {
  ...
  "waxing-faq-utah": "Have questions about waxing? You're not alone. At Wax Me Too , we hear the same questions from new clients every day — and we love answering them. Here are the answers to the most frequently asked questions about professional waxing in Utah. <h2>Does waxing hurt?</h2> This is the question we hear most often. The honest answer: it depends. Most clients describe the sensation as a quick, sharp sting that passes immediately. The bikini and Brazilian areas tend to be more sensitive than legs or arms. The good news: it gets significantly easier with each subsequent visit. By your third or fourth wax, most clients find the experience quite manageable. <h2>How long does hair need to be?</h2> Hair should be at least ¼ inch long — roughly 10 days of growth after shaving, or 3 to 4 weeks after waxing. If you're not sure, it's always better to let it grow a bit longer rather than coming in too soon. <h2>How long do results last?</h2> Most clients enjoy smooth skin for 3–6 weeks after a professional wax. Results vary based on individual hair growth rates and the area waxed. <h2>Can I wax if I'm pregnant?</h2> Yes, waxing is generally safe during pregnancy. However, skin can be more sensitive during pregnancy, so we recommend letting your esthetician know. We'll take extra care to ensure your comfort throughout the service. <h2>Do you offer waxing for men?</h2> Absolutely. We offer a full menu of men's waxing services, including back waxing, chest waxing, eyebrow waxing, and the Manzilian — our Brazilian wax service for men. Our estheticians are experienced and professional, and our treatment rooms are private and comfortable. <h2>What is your hygiene policy?</h2> We never double-dip — fresh applicators are used for every client, every time. Our estheticians wash their hands in front of you before every service. Treatment rooms are sanitized between every client. These are non-negotiable standards at every Wax Me Too location. Have more questions? Visit our full FAQ page , browse our services menu , or find your nearest Wax Me Too location .",
