...
export default function BeforeCare() {
  ...
  usePageSEO(
    "Before Care Guide — How to Prepare for Your Wax | Wax Me Too",
    "Get the best possible waxing results by following Wax Me Too’s before-care guide. Learn what to do (and avoid) in the days before your appointment.",
  );
        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <FadeUp delay={200}>
            <div className="mt-10 bg-[#CFA7A0] rounded-lg p-6 text-center">
              ...
              <p className="text-[#3B2F2A]/80 font-body text-sm mb-4">First time at Wax Me Too? Get your Brazilian wax for $50.</p>
