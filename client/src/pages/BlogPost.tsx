  ...
  switch (slug) {
    ...
    case "south-jordan-6th-location-opening":
      return `
        ...
        <ul>
          ...
          <li><strong>20% off for new clients.</strong> Your first service at any Wax Me Too location comes with a 20% new client discount.</li>
        </ul>
        <h2>Book Your Appointment</h2>
    ...
    case "wax-me-too-difference-local-salon":
      return `
        ...
        <ul>
          ...
          <li><strong>20% off for new clients.</strong> We want you to experience the Wax Me Too difference risk-free.</li>
        </ul>
        <h2>6 Locations Across Utah</h2>
        <p>With studios in Layton, Salt Lake City, South Jordan, Draper, Orem, and St. George, we're Utah's most accessible professional waxing studio. Book online at waxmetoo.com — your first visit is 20% off.</p>
      `;
    ...
    case "summer-waxing-utah-guide":
      return `
        ...
        <h2>Book at Any of Our 6 Utah Locations</h2>
        <p>Wax Me Too has studios in Layton, Salt Lake City, South Jordan, Draper, Orem, and St. George. Book online and enjoy 20% off your first service.</p>
      `;
    ...
    case "wax-me-too-happy-faces-community":
      return `
        ...
        <p>Book your next appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "draper-waxing-salon-expansion":
      return `
        ...
        <h2>Book Your Appointment</h2>
        <p>Book online at waxmetoo.com and select the Draper location. New clients receive 20% off their first service. We'd love to see you in our newly expanded space.</p>
      `;
    ...
    case "salt-lake-city-waxing-salon":
      return `
        ...
        <ul>
          ...
          <li><strong>20% off for new clients</strong></li>
        </ul>
    ...
    case "layton-waxing-salon-new-location":
      return `
        ...
        <p>Book online at waxmetoo.com and select the Layton location. Military personnel: look for the military discount option when selecting your service. New clients receive 20% off their first service.</p>
      `;
    ...
    case "layton-waxing-salon-new-team":
      return `
        ...
        <p>Book your appointment online at waxmetoo.com and select the Layton location. New clients receive 20% off their first service.</p>
      `;
    ...
    case "hair-removal-layton-utah":
      return `
        ...
        <p>Book online at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "ingrown-hair-prevention-waxing":
      return `
        ...
        <p>Book your appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "waxing-before-care-guide":
      return `
        ...
        <h2>Book Your Appointment</h2>
        <p>Ready to experience the Wax Me Too difference? Book online at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "waxing-for-men-manzilian-guide":
      return `
        ...
        <p>Book your men's waxing appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "waxing-sensitive-skin-guide":
      return `
        ...
        <p>Book your appointment at waxmetoo.com and mention your sensitive skin in the notes field when booking. New clients receive 20% off their first service.</p>
      `;
    ...
    case "waxing-while-pregnant-utah":
      return `
        ...
        <p>Our licensed estheticians at all 6 Wax Me Too locations are experienced in working with pregnant clients. Book online at waxmetoo.com and mention your pregnancy in the notes field. New clients receive 20% off their first service.</p>
      `;
    ...
    case "15-minute-brazilian-wax-experience":
      return `
        ...
        <p>Book your Brazilian wax at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "naked-and-afraid-first-brazilian":
      return `
        ...
        <p>Ready to take the plunge? Book at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "bikini-wax-types-explained":
      return `
        ...
        <p>Book your bikini wax at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "eyebrow-design-waxing-guide":
      return `
        ...
        <p>Book your eyebrow wax, tint, or design appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "underarm-waxing-guide-utah":
      return `
        ...
        <p>Book your underarm waxing appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "brazilian-wax-benefits-vs-shaving":
      return `
        ...
        <h2>The Verdict</h2>
        <p>For anyone who shaves regularly, switching to professional waxing is one of the best decisions you can make for your skin and your routine. Book your first Brazilian wax at waxmetoo.com — new clients receive 20% off.</p>
      `;
    ...
    case "throw-away-your-razor":
      return `
        ...
        <p>Your first step: stop shaving now and let your hair grow to at least ¼ inch (about 10 days). Then book your first appointment at waxmetoo.com. New clients receive 20% off their first service.</p>
    ...
    case "pre-vacation-waxing-checklist":
      return `
        ...
        <p>Wax Me Too has 6 locations across Utah. Book online at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "spring-adventure-waxing-utah":
      return `
        ...
        <p>Spring appointments fill up fast — book early at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "sundance-film-festival-waxing-utah":
      return `
        ...
        <p>Our Draper and Salt Lake City studios are the most convenient for Sundance attendees. Book online at waxmetoo.com — new clients receive 20% off their first service.</p>
      `;
    ...
    case "valentines-day-waxing-rippp-and-swear":
      return `
        ...
        <p>Never tried a Brazilian wax before? Valentine's Day is the perfect occasion for your first experience. New clients receive 20% off their first service — and our estheticians are experts at making first-timers feel comfortable and at ease.</p>
    ...
    case "valentines-day-free-wax-giveaway-2017":
      return `
        ...
        <p>Valentine's week fills up fast. Book your appointment now at waxmetoo.com — new clients receive 20% off their first service. And don't forget to enter our giveaway for a chance to win a free service!</p>
      `;
    ...
    case "free-bikini-wax-drawing-utah":
      return `
        ...
        <h2>About Wax Me Too</h2>
        <p>Wax Me Too has been Utah's most trusted waxing studio since 2007. We have 6 locations across the state — Layton, Salt Lake City, South Jordan, Draper, Orem, and St. George. Book at waxmetoo.com. New clients receive 20% off their first service.</p>
      `;
    ...
    case "south-jordan-waxing-grand-opening":
      return `
        ...
        <h2>Book Your Appointment</h2>
        <p>Book online at waxmetoo.com and select the South Jordan location. New clients receive 20% off their first service. We're so excited to be part of the South Jordan community — we can't wait to meet you.</p>
      `;
    ...
    case "st-george-waxing-salon-utah":
      return `
        ...
        <p>Book online at waxmetoo.com and select the St. George location. New clients receive 20% off their first service.</p>
      `;
    ...
    case "mens-eyebrow-waxing-metrosexual":
      return `
        ...
        <p>Book at waxmetoo.com and select "Men's Eyebrow Wax" from the service menu. New clients receive 20% off their first service.</p>
      `;
